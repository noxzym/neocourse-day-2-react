...
export default function Profile() {
    ...
    return (
        <main className="mx-auto flex max-w-6xl flex-col gap-8 py-12">
            <section className="flex flex-wrap items-center justify-center gap-x-12">
                <img
                    width={100}
                    height={100}
                    src={profilePic}
        ...
        px-3 py-2 dark:text-white`}
            ...
            <AnimatePresence mode="wait">
                {!isEditing ? (
                    ...
                    >
                        <form onSubmit={handleFormSubmit} className="rounded-lg px-4 py-3">
